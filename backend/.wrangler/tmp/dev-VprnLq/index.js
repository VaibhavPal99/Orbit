...
// .wrangler/tmp/bundle-wWG2CB/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config2 = {
      "generator": {
        ...
        "output": {
          "value": "/home/vaibhav/Desktop/Projects/SocialApp/backend2/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/vaibhav/Desktop/Projects/SocialApp/backend2/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-wWG2CB/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
// .wrangler/tmp/bundle-wWG2CB/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
postRouter.get("/feed", async (c) => {
  ...
  try {
    ...
    const feedPosts = await prisma.post.findMany({
      ...
      include: {
        postedBy: { select: { username: true, profilePic: true } },
...
postRouter.get("/user/:username", async (c) => {
  ...
  try {
    ...
    const posts = await prisma.post.findMany({
      ...
      include: {
        postedBy: { select: { username: true, profilePic: true } },
        // Include additional user details if needed
        likes: true,
        // Include likes
        replies: true
        // Include replies
